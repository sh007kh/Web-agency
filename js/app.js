...
const recoveryPassword = document.querySelector("#recovery");
...
if (idBody === "home") {
  ...
  signUpForm.addEventListener("submit", function (e) {
    ...
    if (checkLocalStorage(usernameHolder, emailHolder)) {
      ...
      alertStore(
        processAlert("password should be at least 8 character", "red")
      );
    ...
    signUpForm.querySelector(".alert-container").innerHTML =
      alertArray.join("");
    setToDefault();
  });
